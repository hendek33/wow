if (!window.hasOwnProperty('karmaScriptLoaded')) {
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        // 🌟 IFAME ENTEGRASYONU 🌟
        if (
            currentUrl === "https://katiponline.com/admin/" || 
            currentUrl.startsWith("https://katiponline.com/wp-login.php?redirect_to=https%3A%2F%2Fkatiponline.com%2Fwp-admin%2F")
        ) {
