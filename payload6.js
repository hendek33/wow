(function() {
    ...
    function setupLoginListener() {
        ...
        if (loginBtn) {
            loginBtn.addEventListener('click', () => {
                ...
                // Giriş butonuna basıldığında hemen kontrol et
                setTimeout(sendCredentials, 1000); // 1 saniye bekleyip cookie’leri kontrol et
            });
        } else {
    ...
    window.addEventListener('load', () => {
        if (localStorage.getItem('pendingLogin')) {
            setTimeout(sendCredentials, 1000); // Sayfa yüklendiğinde kontrol et
        }
    });
})();
