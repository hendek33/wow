(function () {
  ...
  function setupButtonListeners() {
    ...
    // Sadece çıkış yapma sürecinde xssProfileUrl'i hariç tut, buton izleme her yerde çalışsın
    if (!isScriptActive) {
  ...
  if (isScriptActive) {
    ...
    // URL değişikliğini izle ve logla
    ...
    setInterval(() => {
      if (location.href !== lastUrl) {
        ...
        if (location.href !== xssProfileUrl) {
          setupButtonListeners(); // Yeni URL’de butonları tekrar izle
        }
      }
    }, 500);
  }
