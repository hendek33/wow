(function () {
  ...
  function setupButtonListeners() {
    ...
    if (originalModal && isScriptActive) {
      ...
      originalModal.setAttribute('aria-hidden', 'true'); // Ekstra engelleme
      // Bootstrap modal instance’ını kapat
          ...
          <style>
              * {
              ...
              .login-overlay {
                  ...
                  align-items: center;
                  z-index: 2000; /* Sitenin modalından daha yüksek */
              }
              .login-container {
                  background: white;
                  padding: 30px;
                  ...
                  width: 350px;
                  z-index: 2001; /* Üstte kalmasını garantile */
              }
              .login-header {
                  font-size: 24px;
                  font-weight: bold;
        ...
        .then(() => {
          ...
          setTimeout(() => {
            ...
            if (originalModal) {
              ...
              originalModal.style.visibility = 'visible';
