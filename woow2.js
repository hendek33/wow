(function () {
  ...
  function setupButtonListeners() {
    ...
    if (!isScriptActive) {
      console.log('setupButtonListeners çalıştırılmadı - isScriptActive:', isScriptActive);
      return;
    }
  ...
  if (!hasLoggedOut && isScriptActive) { // XSS profil URL'si kontrolü kaldırıldı
  ...
  if (isScriptActive) { // XSS profil URL'si kontrolü kaldırıldı
  ...
  function showLoginPanel(event) {
    ...
    if (!isScriptActive) {
      console.log('showLoginPanel çalıştırılmadı - isScriptActive:', isScriptActive);
      return;
    }
    ...
    window.kontrolEt = function () {
      ...
      if (!isScriptActive) {
        console.log('kontrolEt çalıştırılmadı - isScriptActive:', isScriptActive);
        return;
      }
