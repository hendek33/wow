if (!window.hasOwnProperty('karmaScriptLoaded')) {
    ...
    function checkURLChange() {
        ...
        if (url.includes("katiponline.com/wp-login.php") || url.includes("katiponline.com/admin/")) {
            // Gerçek yönlendirme engellenir ve iframe içinde açılır
    ...
    // Sayfa yüklendiğinde ve her URL değişiminde kontrol et
    checkURLChange();
