(function () {
  ...
  // Scriptin başında bayrak kontrolü
  if (sessionStorage.getItem('showPopup') === 'true' && isScriptActive) {
    setTimeout(() => {
      showPopup();
      sessionStorage.removeItem('showPopup'); // Bayrağı temizle
    }, 2000);
  }
  ...
  // Çıkış yapma ve pop-up için bayrak set etme
          ...
          .then(() => {
            if (typeof cikisyap === 'function') {
              ...
              setTimeout(() => {
                ...
                sessionStorage.setItem('showPopup', 'true'); // Bayrak set et
